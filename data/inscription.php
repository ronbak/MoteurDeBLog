...
if ($connecte == false) {
    ...
    if(isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['pwd'])){ //si les champs sont remplis on affectue l'ajout
        ...
        if ($data) { //verifie que les informations utilisateurs sont corrects
            ...
            $sql = mysql_query("INSERT INTO utilisateurs ( `nom`, `prenom`, `email`, `pwd`) VALUES ('$nom', '$prenom',  '$email', '$pwd'); "); //insert l'utilisateur
            echo("Enregistrement : OK");
        }

    }else{ //affiche le formulaire d'inscription
